I added all of my code in the 'arbree' folder. Within that folder, I added all the class files in the 'pages' folder and connected all the pages with the 'swag.test.ts' file.
